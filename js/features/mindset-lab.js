...
(function () {
  ...
  let mindsetItems = [
    ...
    { id: "pros-2", category: "Prospecting Psychology", content: "Most realtors hate prospecting because they made it about them instead of about the other person.", source: "Mindset Lab Original", action: "For the next 10 conversations, lead with a question about them (their business, their clients, their goals) before any real estate talk." },
    ...
    { id: "pros-4", category: "Prospecting Psychology", content: "The fortune is in the follow-up. The follow-up is where most realtors quietly quit.", source: "Mindset Lab Original", action: "Open your CRM or spreadsheet right now and schedule the next follow-up for every open opportunity or past client." },
