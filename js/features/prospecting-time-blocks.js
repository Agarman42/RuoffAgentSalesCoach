 ...
 *
 * Compatibility shim — Prospecting Time Blocks merged into Weekly Win Plan (v2).
 * Redirects legacy calls; migration handled in weekly-win-plan.js.
 */
...
(function () {
  ...
  function initProspectingTimeBlocks() {
    console.log('%c[prospecting-time-blocks.js] Shim active — merged into Weekly Win Plan', 'color:#00A89D');
    if (typeof window.updateWeeklyCustomizeDisplays === 'function') {
      window.updateWeeklyCustomizeDisplays();
    }
  }

  // Legacy API — delegate to unified Weekly Win Plan
